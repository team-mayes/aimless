generate the velocities for this shooting point and write forward.rst
  &cntrl
        ig=-1                   !new random seed each time
        imin =0,                ! minimization: 0=no, 1=yes
        irest=0,                ! restart: 0=no, 1=yesn
        ntx=1,                  ! level of info to read from restart (coords, vels, box dims, formatted file)n
        nstlim=1,              ! number of MD timestepsn
        dt=0.0000001,           ! timestep in ps
        ...
        ntwx=0,                ! frequency to write coords to mdcrd file; =0 means don't writen
        ntpr=1,                 ! frequency to print to log filen
        ntwr=1,               ! frequency to write restart filen
        ...
        nmropt=0,                ! enable complex restraints (umbrella sampling)n
  /
  &ewald
